            ...
            <div className="daybox">
                <label>
                    ...
                    <div className="top">
                        ...
                        <button onClick={wInfoAPI}>刷新</button>
                        
                        <div className="text-area">
                            <div className="temperature">{store.getState()}</div>
                            <div className="infos">
                                <div className="address">臺北市</div>
                                <div className="time">星期二 下午9:00</div>
                            </div>
                        </div>
                    </div>
                    <select className='region-select' ref={cNode=>this.selectedRegion=cNode}>
